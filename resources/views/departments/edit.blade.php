<x-dashboard-layout>
            <x-page-header
                ...
                subtitle="Perbarui data department"
            >
                    ...
                    <form action="{{ route('departments.update', $department->id) }}" method="POST">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="description" rows="3"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $department->description) }}</textarea>
                        </div>
